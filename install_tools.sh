...
if !(type "lazygit" > /dev/null 2>&1); then
  ...
  brew install jesseduffield/lazygit/lazygit > /dev/null 2>&1
fi

# lazydocker
if !(type "lazydocker" > /dev/null 2>&1); then
  echo 'Installing lazydocker...'
  brew install lazydocker > /dev/null 2>&1
fi
...
if !(type "ghq" > /dev/null 2>&1); then
  echo 'Installing ghq...'
  brew install ghq > /dev/null 2>&1
fi

# onefetch
if !(type "onefetch" > /dev/null 2>&1); then
  echo 'Installing onefetch...'
  brew install onefetch > /dev/null 2>&1
fi
