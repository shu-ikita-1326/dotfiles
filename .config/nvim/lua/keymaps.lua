...
vim.keymap.set({ "t", "n" }, "<C-j>j", "<Cmd>wincmd j<CR>", opts)
vim.keymap.set({ "t", "n" }, "<C-j>k", "<Cmd>wincmd k<CR>", opts)
vim.keymap.set({ "t", "n" }, "<C-j>l", "<Cmd>wincmd l<CR>", opts)
vim.keymap.set({ "t", "n" }, "<C-j>h", "<Cmd>wincmd h<CR>", opts)
