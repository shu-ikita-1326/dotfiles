...
local function ddu_key_mapping()
  ...
  vim.keymap.set(
    "n",
    "<Leader>ff",
    "<Cmd>Ddu -ui=ff file_external -ui-param-ff-startAutoAction -ui-param-ff-startFilter=v:true<CR>",
    opt
  )
  vim.keymap.set("n", "<Leader>hp", "<Cmd>Ddu -ui=ff mr -source-param-ff-kind=mrr<CR>", opt)
  vim.keymap.set("n", "<Leader>fr", "<Cmd>Ddu -ui=ff register -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>/",
  ...
  vim.keymap.set("n", "<Leader>fb", "<Cmd>Ddu -ui=ff buffer -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>fh",
    "<Cmd>Ddu -ui=ff help -ui-param-ff-startAutoAction -ui-param-ff-startFilter=v:true<CR>",
    opt
  )
  vim.keymap.set("n", "<Leader>co", "<Cmd>Ddu -ui=ff_colorscheme colorscheme<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>fm",
    "<Cmd>Ddu -ui=ff markdown -ui-param-ff-startAutoAction -ui-param-ff-filterFloatingTitle='matcher: kensaku'<CR>",
    opt
  )
  vim.keymap.set("n", "<Leader>fn", "<Cmd>Ddu -ui=ff nvim-notify -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>fj", "<Cmd>Ddu -ui=ff jumplist -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>fs", "<Cmd>Ddu -ui=ff source -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>gs",
  ...
  vim.keymap.set("n", "<Leader>gd", "<Cmd>Ddu -ui=ff git_diff -source-option-ff-path=`expand('%:p')`<CR>", opt)
  vim.keymap.set("n", "<Leader>gb", "<Cmd>Ddu -ui=ff git_branch -source-param-ff-remote=v:true<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>gl",
    "<Cmd>Ddu -ui=ff git_log -source-param-ff-showGraph -ui-param-ff-startAutoAction<CR>",
    opt
  )
  vim.keymap.set("n", "<Leader>gh", "<Cmd>Ddu -ui=ff ghq -ui='ff_ghq' -ui-param-ff_ghq-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>fd", "<Cmd>Ddu -ui=ff lazy_nvim -ui-param-ff-startFilter=v:true<CR>", opt)
  vim.keymap.set(
    "n",
    "<Leader>fl",
    "<Cmd>Ddu -ui=ff line -ui-param-ff-startFilter=v:true -ui-param-ff-startAutoAction<CR>",
    opt
  )
  vim.keymap.set("n", "<Leader>ftt", "<Cmd>Ddu -ui=ff tab -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>fte", "<Cmd>Ddu -name=floaterm -ui=ff floaterm -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>fta", "<Cmd>Ddu -ui=ff go_task -source-option-ff-defaultAction=run<CR>", opt)
  vim.keymap.set("n", "gd", start_lsp_def, opt)
  vim.keymap.set("n", "gs", start_lsp_ref, opt)
  vim.keymap.set("n", "ge", "<Cmd>Ddu -ui=ff lsp_diagnostic -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "<Leader>ca", "<Cmd>Ddu -ui=ff lsp_codeAction -ui-param-ff-startAutoAction<CR>", opt)
  vim.keymap.set("n", "ds", "<Cmd>Ddu -ui=ff lsp_documentSymbol -ui-param-ff-startAutoAction<CR>", opt)
